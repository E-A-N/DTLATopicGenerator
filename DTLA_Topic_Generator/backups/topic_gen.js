...
topic_starter = new Array("I love how","I\'m so tired of","There\'s a new building called","There\'s a new restaurant called")

east_west_st = new Array('1st','2nd','3rd','4th','5th','6th','7th','8th','9th','10th','11','12','13th','14th','15th','16th','17th','Venice','18th','Washington','Temple','Aliso','Arcadia','Cesar Chavez','Ord','Alphine','College','Winston')

north_south_st = new Array('Bixel','Beaudry','Figueroa','Lebanon','Flower','Hope','Grand','Olive','Hill','Broadway','Spring','Main','Los Angeles','Maple','Wall','San Julian','San Pedro','Crocker','Towne','Stanford','Gladys','Ceres','Central','Alameda','Mateo','Santa Fe')

/// Store all DTLA arrays in single Array for a generator of generators
DTLA_ITEMS = new Array(dtla_places,random_things,things_to_do,people,topic_starter,east_west_st,north_south_st)

function DTLA_gen(indice)
{
	item = DTLA_ITEMS[indice][Math.floor((Math.random() * DTLA_ITEMS[indice].length) -1)];
	item = (item == undefined) ? DTLA_ITEMS[indice][0] : item;
	return item;
